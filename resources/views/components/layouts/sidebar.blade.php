<div class="d-flex flex-column h-100">
  ...
  <div class="p-3 flex-grow-1 sidebar">
    <ul class="nav flex-column gap-1">
      <li class="nav-item">
        <a class="nav-link d-flex align-items-center {{ request()->routeIs('dashboard') ? 'active' : '' }}" wire:navigate
          href="{{ route('dashboard') }}">
          <i class="bi bi-grid me-2"></i> Dashboard
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link d-flex align-items-center {{ request()->routeIs('permohonan-akun') ? 'active' : '' }}"
          wire:navigate href="{{ route('permohonan-akun') }}">
