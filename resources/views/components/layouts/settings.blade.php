  ...
  <div class="row">
    <div class="col-12">
      <ul class="nav nav-tabs mb-4">
        ...
        <li class="nav-item">
          <a class="nav-link {{ request()->routeIs('settings.admin_ecourt') ? 'active' : '' }}" wire:navigate
            href="{{ route('settings.admin_ecourt') }}">
            <i class="bi bi-person-fill-check me-2"></i> Admin E-Court
          </a>
        </li>
      </ul>
      {{ $slot }}
